...
public static class RunRngSetExtension
{
    ...
    internal static Rng GetDefaultRngForHexagram(this RunRngSet rngs) => new(
        seed: rngs.Seed,
        // Loads from save.
    ...
    public static Rng GetRngForHexagram(this RunRngSet rngs) => _hexagramRng.GetValue(rngs, GetDefaultRngForHexagram);
...
{
    [HarmonyPostfix]
    public static void Postfix(RunRngSet __result) => __result.SetRngForHexagram(__result.GetDefaultRngForHexagram());
}
...
{
    [HarmonyPostfix]
    public static void Postfix(RunRngSet __instance) => __instance.SetRngForHexagram(__instance.GetDefaultRngForHexagram());
}
